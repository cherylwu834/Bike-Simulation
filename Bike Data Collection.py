...
class Bike:
    ...
    def update_position(self):
        ...
        #if (self.velocity < 0): #uncomment if don't want velocity to become negative
            #self.velocity = 0
...
def main ():
    ...
    while run and bike1.get_time_elapsed() < MAX_TIME:
